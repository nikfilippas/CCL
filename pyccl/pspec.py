...
class _MatterPowerSpectra(Enum):
    NONE = None
    HALOFIT = 'halofit'
    LINEAR = 'linear'
    EMU = 'emu'
...
class _BaryonPowerSpectra(Enum):
    NONE = 'nobaryons'
    BCM = 'bcm'
...
def rescale_power_spectrum(cosmo, pk, rescale_mg=False, rescale_s8=False):
    ...
    if rescale_mg:
        ...
        cosmo_GR = Cosmology.__new__(Cosmology)
        cosmo_GR.__dict__ = copy.deepcopy(cosmo.__dict__)
